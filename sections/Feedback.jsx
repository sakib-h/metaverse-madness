...
const Feedback = () => (
	<section className="sm:p-16 xs:p-8 px-6 py-12 relative z-10">
		<motion.div
			...
			className="2xl:max-w-[1280px] w-full mx-auto flex flex-col lg:flex-row items-center gap-6">
			<motion.div
				variants={fadeIn('right', 'tween', 0.2, 1)}
				className="flex-[0.5] lg:max-w-[375px] flex flex-col justify-end gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative">
				...
				<p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[40px] text-white">
					...
					using metaverse you can use it in anything"
				</p>
			</motion.div>
